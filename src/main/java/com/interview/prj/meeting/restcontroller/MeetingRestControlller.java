...
public class MeetingRestControlller {
	...
	@PostMapping
	public ResponseEntity<String> saveMeeting (@RequestBody Meeting meeting, UriComponentsBuilder uriBuilder){
	...
	@GetMapping("simple/")
	public ResponseEntity<List<Meeting>> allMeeting ( @RequestBody Meeting meeting){
	...
	@GetMapping("/teste")
	public ResponseEntity<String> deleteMeeting (@RequestParam("data") @DateTimeFormat(pattern = "dd/MM/yyyy HH:mm:ss") Calendar data){
